...
CHRONO_INLINE bool FindXinYString(std::string& x, std::string& y)
{
...
#define MAX_PREDEFINED_NEXTLEVELXP 60
...
public:
	...
	CHRONO_INLINE void SetTextID(uint32 TID) { TextId = TID; }
...
public:
	...
	CHRONO_INLINE uint32 GetLeader() { return LeaderGuid; }
	CHRONO_INLINE uint32 GetID() { return CharterId; }

	CHRONO_INLINE bool IsFull() { return (SignatureCount == Slots); }
};
...
#ifndef WIN32
#define Hearthstone_USE_MAP_PLAYER_INDEX
#ifdef Hearthstone_USE_MAP_PLAYER_INDEX
...
public:
	...
	uint32 GetPlayerTeamByGUID(uint64 guid);
	...
	CHRONO_INLINE bool IsSpellDisabled(uint32 spellid)
	{
